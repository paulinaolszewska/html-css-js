...
// -- o funkcjach należy myśleć jako o małych programach które coś robią z danymi lub coś zwracają (lub robią i to i to). Funkcja może modyfikować program (nazywamy to efektem ubocznym) lub go nie modifikować a jedynie przetwarzać elementy zwracając nową wartość (służy do tego słowo kluczowe return).
...
//  nazwa(argument1, argument2) - wywołanie z argumentami
